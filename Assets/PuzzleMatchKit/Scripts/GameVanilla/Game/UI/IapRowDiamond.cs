...
#pragma warning restore 649
        ...
        public void OnDiamondPurchaseButtonPressed()
        {
            ...
            if (storeController != null)
            {
                ...
                buyDiamondsPopup.OpenLoadingPopup();
            }
#else
            PuzzleMatchManager.instance.coinsSystem.BuyDiamond(cachedItem.numCoins);
            PlayerPrefs.SetInt("num_diamond", PlayerPrefs.GetInt("num_diamond") + int.Parse(numCoinsText.text));
            GameObject.Find("BuyDiamondsPopup").GetComponent<BuyDiamondPopup>().OnDiamondChanged(PlayerPrefs.GetInt("num_diamond")) ;
#endif
        }
    }
}
